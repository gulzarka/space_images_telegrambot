...
def create_arguments():
    ...
    parser.add_argument(
        "-t", "-timer", default=14400, type=int, required=False, help="Timer in seconds. Default: 14400(4 hours)"
    )
    parser.add_argument("-f", "-folder", default="images", required=False, help="Image folder. Default: images")
    parser.add_argument("-i", "-image", required=False, help="Specific image to upload")
